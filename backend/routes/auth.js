...
// route -1 : No login required. Post data at http://localhost:5000/api/auth/createuser
...
// ROUTE - 2:  No login required. Post data at http://localhost:5000/api/auth/login
router.post('/login',[
    body("email", "Enter a valid email").isEmail(),
